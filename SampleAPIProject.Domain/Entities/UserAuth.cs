...
namespace MLMProject.Domain.Entities
{
    public class UserAuth
    {
        ...
        [Required]
        [PhoneNumberValidation(ErrorMessage = "Invalid Indian phone number. Must start with 7, 8, or 9 and be 10 digits long.")]
        ...
        public bool? IsDistributorRequest { get; set; } = false;
