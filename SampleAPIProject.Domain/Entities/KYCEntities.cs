...
namespace MLMProject.Domain.Entities
{
    public class KYCEntities
    {
        ...
        [Required]
        [Url]
        public required string UserPanCardUrl { get; set; }

        [Required]
        [Url]
        public required string AadharCardFrontUrl { get; set; }

        [Required]
        [Url]
        public required string AadharCardBackUrl { get; set; }

        [Required]
        [Url]
        public required string PassbookPhotoUrl { get; set; }
